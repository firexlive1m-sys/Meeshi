...
app.post("/api/verify-payment", express.json(), async (req, res) => {
  try {
    ...
    // Signature matches, mark as paid. We also want to record the purchase like Cashfree webhook does.
    // If the frontend sends purchaseData (email, name, plan, etc.), we can save it here.
